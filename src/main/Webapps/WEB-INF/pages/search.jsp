...
<body>
	...
	<div class="container-fluid homebg">
		<!-- row_split-->
		<div class="row">
			<div class="col-xs-12 col-sm-12 all_cases_col">
				<div class="col-xs-12 col-sm-3 all_cases_col_by_rec">
				
					<h5 class="text-center">SEARCH BY POLICY OR RECEIPT NO</h5>
					<div class="row">
					
<!-- 						<div class="col-xs-6 col-sm-6 sub_col">
					   ...
					   <div class="col-xs-6 col-sm-10 sub_col marg">
							<div class="form-group">
								<div class="input-group ">                       
									<span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
									<input type="text" class="form-control" id="asearch" placeholder="Enter Policy Or Receipt No">
								</div>
							</div>
						</div>
						
						<div class="col-xs-6 col-sm-2 sub_col">
				          <div class="form-group">
								<div class="input-group">                       									
						...
						<div class="col-xs-6 col-sm-2 text-center sub_col">
						</div>
						</div>
...
<!-- 					</div> -->
				...
				<div class="col-xs-12 col-sm-9">
					...
					<div class="row">
						<div class="col-xs-6 col-sm-2 sub_col start">
						...
						<div class="col-xs-6 col-sm-2 sub_col end">
...
<!-- 							<div class="col-xs-6 col-sm-2 sub_col ">
									...
									<div class="input-group">
									   <div id="radioGroup">                    
										<span class="input-group-addon"><span class="glyphicon glyphicon-list-alt"></span></span>
										     ...
										     <input type="radio" name="type" value="Policy" class="radio_type" id="radio_type1">
										     </div>
										     <div class="wrap">
										     <label for="Receipt">Receipt</label>
                                              <input type="radio" name="type" value="Receipt" class="radio_type" id="radio_type2">
                                              </div>
										</div>
									</div>
								</div>
	                        ...
	                        <div class="col-xs-6 col-sm-2 sub_col slt_prd">
								<div class="form-group">
									<div class="input-group">                       
										<span class="input-group-addon"><span class="glyphicon glyphicon-list-alt"></span></span>
									...
									<!-- For Status -->
							<div class="col-xs-6 col-sm-2 sub_col slt_status">
								<div class="form-group">
									<div class="input-group">                       
										<span class="input-group-addon"><span class="glyphicon glyphicon-list-alt"></span></span>
										<select  class="form-control" id="status" >
											...
											<option value='Receipt Fail'>Receipt Fail</option>
							...
							<div class="col-xs-6 col-sm-2 sub_col slt_mfr">
								<div class="form-group">
									<div class="input-group">                       
										<span class="input-group-addon"><span class="glyphicon glyphicon-list-alt"></span></span>
										<select  class="form-control" id="mfg" >
											<option value=''>Select Manufacture</option>
											<option value='Honda'>Honda</option>
											<option value='Maruti'>Maruti</option>
											<option value='Tata'>Tata</option>
											<option value='Ford'>Ford</option>
											<option value='Adithya'>Abibl</option>
											<option value='Mahindra'>Mibl</option>
		              ...
		              <div class="col-xs-6 col-sm-2 sub_col">
								<button class="btn btn-default search-by-data" id="oemebutton">Search</button>						
							</div>		
